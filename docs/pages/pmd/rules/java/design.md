...
## ExcessiveMethodCount

**Since:** PMD 3.0

**Priority:** Medium (3)

Пересоздание правила TooManyMethods на языке Java

**This rule is defined by the following Java class:** [net.sourceforge.pmd.lang.java.rule.design.ExcessiveMethodCountRule](https://github.com/pmd/pmd/blob/master/pmd-java/src/main/java/net/sourceforge/pmd/lang/java/rule/design/ExcessiveMethodCountRule.java)
...
**Use this rule with the default properties by just referencing it:**
``` xml
<rule ref="category/java/design.xml/ExcessiveMethodCount" />
```
